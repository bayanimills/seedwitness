...
Vendored unmodified from rdagger/micropython-ili9341 (MIT license), fetched
2026-08-01. Default calibration (x_min=100, x_max=1962, y_min=100, y_max=1900)
is a commonly-cited CYD starting point, not device-specific -- verify/adjust
against real hardware. SeedWitness passes its calibrated bounds from
drivers/cyd.py; see that module for the active pin and touch-bus profile.
"""
